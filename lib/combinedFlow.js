...
async function combinedFlow({
  ...
  try {
    ...
    if (packageType) {
      ...
      const packageDropdown = frame.locator('.package-selected-packing, span:has-text("Mini Package"), span:has-text("Midi Package"), span:has-text("Double Mini Package"), span:has-text("Envelpe"), span:has-text("Custom dimensions")').first();
